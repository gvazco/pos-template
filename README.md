...
- **POS-CMS**: Web interface at cms-pos.core-hub-plex.cloud
- **API**: REST API at api-pos.core-hub-plex.cloud
...
4. Access the POS-CMS at cms-pos.core-hub-plex.cloud and API at api-pos.core-hub-plex.cloud (configure DNS accordingly).
...
4. In Dokploy UI, configure custom domains:
   - For POS-CMS service: cms-pos.core-hub-plex.cloud
   - For API service: api-pos.core-hub-plex.cloud
